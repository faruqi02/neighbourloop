import { Listing, RecycleCenter, HelpRequest, User, DonationItem, ActivityItem } from '../types';
...
export const mockListings: Listing[] = [
  {
    ...
    description: 'Meja belajar kukuh kayu jati, sangat sesuai untuk pelajar.',
    price: 40,
    category: 'Perabot',
    condition: 'Terpakai',
    distance: 1.2,
  ...
  },
  {
    ...
    description: 'Basikal berkeadaan baik, brek dan tayar baru ditukar.',
    price: 120,
    category: 'Lain-lain',
